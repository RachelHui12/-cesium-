  ...
  <div class="cesium">
    ...
    <div id="toolbarRight">
      <b-tooltip v-if="showUI" label="Github" position="is-left">
        <a class="cesium-button cesium-toolbar-button" href="https://github.com/RachelHui12/satvis.git" target="_blank" rel="noopener">
          <span class="icon fill-parent">
      ...
      <b-tooltip v-if="showUI" label="Chart statistics" position="is-left">
        <a class="cesium-button cesium-toolbar-button" href="../../data/satelliteStatistic.html" rel="noopener">
          <span class="icon fill-parent">
